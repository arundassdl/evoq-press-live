...
"""
	...
	def create_agent_job(
		...
		if not self.server:
			frappe.throw(
				_("Server is missing for Agent Job: {0}. Please ensure the {1} is correctly associated with a server.").format(
					job_type, site or bench or code_server or upstream or host or self.server_type
				)
			)
